export const indexWorked = [
    {
        id: 1,
        description: (
            <>
                <span className="highlight-text-black">Inteligência Artificial (IA),
                    serviços financeiros, SaaS, pagamentos,</span> faturamento, abrangendo investimentos
                e economia em <span className="highlight-text-black">fintechs de alto nível</span>.
            </>
        ),
    },
    {
