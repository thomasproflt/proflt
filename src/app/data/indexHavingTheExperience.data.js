const Graph = (
    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-file-bar-graph" viewBox="0 0 16 16">
...
const Tencent = (
    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-tencent-qq" viewBox="0 0 16 16">
...
export const indexHavingTheExperience = [
    {
        id: 1,
        svg: Graph,
        title: "Complexidade",
        description:
            "Dificulta que os usuários alcancem seus objetivos",
    },
    {
        id: 2,
        svg: Tencent,
        title: "Necessidades Pouco Atendidas",
        description:
