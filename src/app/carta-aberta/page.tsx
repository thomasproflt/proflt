        ...
        <div className="min-h-screen items-center justify-start font-sans">
            ...
            >
                ...
                >
                    ...
                    >
                        Baixe <span className="highlight-text">o arquivo Carta Aberta</span>
                    </motion.h1>
                    ...
                    >
                        Clique em Baixar para realizar o download do word carta aberta! Obrigado Professor.
                    </motion.p>
                    <a
                        href="/carta-aberta-grupo-foco-futuro.docx"
                        download="carta-aberta-grupo-foco-futuro.docx"
                    ...
                    >
                        <span className="text-[14px] text-white">Baixar carta</span>
                    </a>
