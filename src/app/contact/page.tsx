    ...
    return (
        <div className="min-h-screen items-center justify-start font-sans">
            ...
            >
                ...
                >
                    <h1 className="max-w-[30rem] text-6xl text-zinc-600 dark:text-zinc-400">
                        Let’s  Connect.
                    </h1>
                    <p className="max-w-[35rem] text-lg leading-8 text-zinc-600 dark:text-zinc-400">
                        I’d love to hear from you. Whether you’re interested in collaborating, discussing new opportunities, or just want to say hi.
                    </p>
                    <div className="flex items-center justify-center gap-5">
                        ...
                        >
                            <span className="text-[16px] text-black font-medium">Connect on Linkedin</span>
                        </a>
                        ...
                        >
                            <span className="text-[16px] text-white">Send a Message</span>
                        </a>
                    </div>
                    ...
                    <div className="flex flex-row max-w-full w-full bg-[#161617] p-5 gap-10 rounded-2xl">
                        ...
                        <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="max-w-[30rem] text-left font-semibold text-[16px] text-zinc-600 dark:text-zinc-400 mb-[3rem]">
                                Explore how my experience can support your needs.
                            </p>
                            <div className="flex items-center justify-center gap-5">
                                <a
                                    href={
                                    ...
                                    className="flex items-center justify-center gap-2 bg-white border border-solid border-black/[0.08] px-5 py-3 rounded-full hover:bg-black/[0.04] dark:border-white/[0.145] dark:hover:bg-white/80 transition-all duration-200"
                                >
                                    <span className="text-[16px] text-black font-medium">View Work</span>
                                </a>
