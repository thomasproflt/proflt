        ...
        <div className="min-h-screen items-center justify-center flex flex-col">
            ...
            <main className="flex flex-col w-full">
                ...
                <section className="flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-start text-white text-sm w-full">
                    <div className="flex flex-col items-center lg:items-start justify-center lg:justify-start lg:ml-40 gap-1">
                        <NavLink
                        ...
                        >
                            {({ isActive }) => (
                                <>
                                    {isActive && (
                                        <div className=""></div> /**absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-[hsl(0,0%,20%)] to-[hsl(0,0%,50%)] */
                                    )}
                                    Aetheris Privacy
                                </>
                            )}
                        ...
                        <div className="flex flex-col lg:flex-row items-start justify-center gap-8 lg:px-10 lg:gap-8 w-full">
                            <div className="flex flex-col w-full items-start justify-center text-left lg:text-left px-2">
                                <div className="flex flex-col items-start justify-center gap-3">
                                    ...
                                    <p className="flex text-1xl text-gray-400 font-light">O Aetheris não coleta informações pessoais de usuários além dos dados necessários para seu funcionamento no Discord (como ID de usuário e servidor).<br />
                                        <br />
                                        Esses dados não são compartilhados com terceiros e são armazenados de forma temporária.<br />
                                        <br />
                                        Caso deseje excluir seus dados, entre em contato via: aetherisofficialsuporte@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
